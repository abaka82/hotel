(function () {
  ...
  angular
    .module('prices')
    .controller('PricesListController', PricesListController);

  PricesListController.$inject = ['PricesService'];

  function PricesListController(PricesService) {
    var vm = this;

    vm.prices = PricesService.query();
    ...
    vm.byPriceRange = function (minValue, maxValue) {
      ...
      return function predicateFunc(item) {
        ...
        var price1 = item.prices_comPrice.match(numberPattern);
        if (price1 !== null) {
