(function () {
  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('carts.edit', {
        ...
        data: {
          roles: ['user', 'admin'],
          pageTitle: 'Edit Cart {{ cartResolve.title }}'
        }
      })
      .state('carts.view', {
        url: '/:cartId',
        ...
        data: {
          pageTitle: 'Cart {{ cartResolve.title }}'
        }
      });
  }
  ...
  getVouchers.$inject = ['$stateParams', 'VouchersService'];

  function getVouchers($stateParams, VouchersService) {
    return VouchersService.query().$promise;
  }
}());
