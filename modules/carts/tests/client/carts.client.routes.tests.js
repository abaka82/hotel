  ...
  describe('Carts Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        var liststate;
        beforeEach(inject(function ($state) {
          liststate = $state.get('carts.list');
        }));
        ...
        it('Should have template', function () {
          expect(liststate.templateUrl).toBe('modules/carts/client/views/list-carts.client.view.html');
        });
      });
      ...
      describe('View Route', function () {
        ...
        it('should attach an cart to the controller scope', function () {
          expect($scope.vm.cart._id).toBe(mockCategory._id);
        });
